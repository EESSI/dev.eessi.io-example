...
sources = [
{
    'source_urls': ['https://i10git.cs.fau.de/api/v4/projects/walberla%2Fwalberla/repository/archive?sha=%(software_commit)s'],
    'filename': 'walberla-%(software_commit)s.tar.gz',
},
]
patches = [
    'waLBerla-6.1-codegen-fix-missing-cstint.patch',
]
checksums = [
    {'waLBerla-6.1-codegen-fix-missing-cstint.patch':
     'c15fc9e1a1060e7e55be14023486824d9bac73096ce27199301627de5c69d5bb'},
]
